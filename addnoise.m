...
%   此处显示详细说明
resolution=noise_parameter.resolution;
try
    ...
    if noise_parameter.add_gaussian==1
        ...
        fprintf('gauss noise with paramter %g was adding.\n',noise_parameter.gaussian);
    else
        gauss=0;
    ...
    if noise_parameter.add_blankedges==1
        ...
        fprintf('blank edge noise with paramter %g was adding.\n',bkratio);
    else
        bkratio=0;
    end   
    cd('.\projection_data')
